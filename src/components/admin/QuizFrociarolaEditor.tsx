...
import {
  ...
  useUpdateQuizFrociarolaContent,
  getGetQuizFrociarolaContentQueryKey,
...
export function QuizFrociarolaEditor() {
  const { toast } = useToast();
  const queryClient = useQueryClient();
  const { data, isLoading } = useGetQuizFrociarolaContent();
  const update = useUpdateQuizFrociarolaContent();
      ...
      { data: cleaned },
      {
        onSuccess: () => {
          queryClient.invalidateQueries({
            queryKey: getGetQuizFrociarolaContentQueryKey(),
          });
